 ...
 *  @version $Id: LocalTimeStringConverter.java 1125 2024-03-22 15:34:01Z tquadrat $
 *  @since 0.0.6
 *
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: LocalTimeStringConverter.java 1125 2024-03-22 15:34:01Z tquadrat $" )
...
public class LocalTimeStringConverter extends TimeDateStringConverter<LocalTime>
{
     ...
     *  Creates a new {@code LocalTimeStringConverter} instance.
     *
     *  @note The formatter may not drop any part of the local time, otherwise
