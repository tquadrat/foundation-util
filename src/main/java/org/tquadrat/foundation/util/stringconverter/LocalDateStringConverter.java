 ...
 *  @version $Id: LocalDateStringConverter.java 1125 2024-03-22 15:34:01Z tquadrat $
 *  @since 0.0.6
 *
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: LocalDateStringConverter.java 1125 2024-03-22 15:34:01Z tquadrat $" )
...
public class LocalDateStringConverter extends TimeDateStringConverter<LocalDate>
{
    ...
    ====** Constructors **=====================================================
        \*--------------*/
    /**
     *  Creates a new {@code LocalDateStringConverter} instance.
     */
    public LocalDateStringConverter() { super( LocalDate.class ); }

    /**
     *  Creates a new {@code LocalDateStringConverter} instance.
     *
     *  @note The formatter may not drop any part of the local date, otherwise
     ...
     */
    @Override
    protected final LocalDate parseDateTime( final CharSequence source, final Optional<DateTimeFormatter> formatter ) throws DateTimeParseException
    {
        final var retValue = LocalDate.from( formatter.orElse( ISO_LOCAL_DATE ).parse( source ) );
