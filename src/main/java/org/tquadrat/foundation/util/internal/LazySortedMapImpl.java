 ...
 *  @version $Id: LazySortedMapImpl.java 1258 2026-06-04 18:33:06Z tquadrat $
 *  @since 0.0.5
 *
 ...
 *  @UMLGraph.link
 */
@ClassVersion( sourceVersion = "$Id: LazySortedMapImpl.java 1258 2026-06-04 18:33:06Z tquadrat $" )
...
public final class LazySortedMapImpl<K,V> extends LazyMapImpl<K,V> implements LazySortedMap<K,V>
{
     ...
     *      values to the map on initialisation, {@false} if it will
     *      create an empty map.
